...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","errorBeacon":"bam.nr-data.net","licenseKey":"7840d0c136","applicationID":"2909452","transactionName":"Jg1bREUOClsARUpHBhYRXF9ZEklZAEA=","queueTime":1,"applicationTime":26,"agent":""}</script>
			...
			<div id="form-oldschool">
				<form action="#" accept-charset="UTF-8"
					...
					<div class="form-fields">
						<fieldset>
							<label for="login">用户名</label> <input type="text"
								name="login" id="login" tabindex="1" class="text-input"
						...
						<fieldset>
							<label for="password">密码</label> <input
								...
								tabindex="2" class="text-input">
						</fieldset>
					</div>

					<input class="button" type="submit" value="Sign In" tabindex="3">
				</form>
			</div>
