...
<head>
	...
	<script type="text/javascript">
		...
		function logout(){
			$.ajax({
				url: "${ctx}/logout?_=" + new Date().getTime(),
				type: "post",
				dataType: "json",
				cache: false,
...
<div id="main">
	<div id="header" class="navbar navbar-fixed-top">
		<div class="navbar-inner">
			...
			<ul id="userControl" class="nav pull-right">
				...
				<li><a href="javascript:void(0);" onclick="logout();" title="退出登录">退出</a></li>
				<li>&nbsp;</li>
			</ul>
	...
	<div class="container-fluid">
		...
		<div id="footer" class="row-fluid">
			Copyright &copy; 2017-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://itdaima.com" target="_blank">itdaima</a> ${fns:getConfig('version')}
		</div>
	</div>
</div>
<script type="text/javascript">
