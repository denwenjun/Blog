      ...
      <div class="row">
        <div class="col-sm-12 col-md-12" id="left-panel-left-one" style="padding:5px 5px;">
          <div>
            ...
            <form action="${ctx}/blogFrom${urlSuffix}" method="post">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <span style="font-weight: bold;">发表博客</span>
                </div>
                <div class="panel-body">
                  ...
                  <div class="form-group">
                    <label>内容*</label>
                    <textarea class="form-control" name="content" style="resize:none; height:200px;" id="editor1">
                      ${content}
                    </textarea>
                    <script>
                  ...
                  <div class="pull-right">
                    <button type="submit" class="btn btn-success">发表博客</button>
                  </div>
                </div>
              </div>
            </form>
