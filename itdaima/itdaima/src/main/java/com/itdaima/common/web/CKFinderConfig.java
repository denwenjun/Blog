 ...
 *
 */
package com.itdaima.common.web;

import javax.servlet.ServletConfig;
import javax.servlet.http.HttpServletRequest;

import com.itdaima.common.config.Global;
import com.itdaima.common.utils.FileUtils;
...
public class CKFinderConfig extends Configuration {
    ...
    protected Configuration createConfigurationInstance() {
		...
		boolean isView = true;//UserUtils.getSubject().isPermitted("front:ckfinder:view");
		boolean isUpload = true;//UserUtils.getSubject().isPermitted("front:ckfinder:upload");
		boolean isEdit = true;//UserUtils.getSubject().isPermitted("front:ckfinder:edit");
