package com.itdaima.modules.share.web;
...
public class ShareController extends BaseController {
     ...
     * 分享
     */
    @RequestMapping(value={"/share{urlSuffix}","/share/p{pageNo}${urlSuffix}"})
    public String share(Model model,HttpServletRequest request, HttpServletResponse response,
        ...
        model.addAttribute("navbarType", "share");
        ...
        if(StringUtils.isNotBlank(url) && !url.equals("t/share")){
        ...
        return "modules/share/share";
    }

    /**
     * 发表分享
     */
    @RequestMapping(value="/shareFrom${urlSuffix}")
    public String blogFrom(Model model,String title, String articleType,String content, HttpServletRequest request) {
        ...
        if(StringUtils.isNotBlank(content)){
            ...
            LogUtils.saveLog(Servlets.getRequest(), "发表分享");
            model.addAttribute("message", "分享发表成功！已在审核中...");
        }
        Dict dict = new Dict();
        dict.setType("atricle_type");
        List<Dict> dictList = dictService.findList(dict);
        model.addAttribute("dictList", dictList);
        return "modules/share/shareFrom";
    }
     ...
     * 查看博客详情
     */
    @RequestMapping(value="/shareView/{id}${urlSuffix}")
    public String shareView(Model model, @PathVariable String id) {
        ...
        return "modules/share/shareView";
    }
}
